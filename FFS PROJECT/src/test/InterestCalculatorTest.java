...
import logic.BadCreditRating;
import logic.InterestCalculator;

public class InterestCalculatorTest {

	@Test
	public void calcInterestRateTest() throws BadCreditRating {
	...
	@Test
	public void calcInterestRateTest2() throws BadCreditRating {
		InterestCalculator intcalc = new InterestCalculator();
		double currentRate = 5.0;
	...
	@Test
	public void calcInterestRateTest3() throws BadCreditRating {
		InterestCalculator intcalc = new InterestCalculator();
		double currentRate = 5.0;
