...
/**
 * Test tool for developers working the InterestRate class. The test tool can
 * supply mock instances of InterestRate with predictable interest rates.
 * 
...
public class InterestRateTestTool {
	...
	/**
	 * @param interestRate
	 *            specifies the desired interest rate
	 * @return A mock instance of InterestRate that responds with a fixed interest
	 *         rate
	 */
