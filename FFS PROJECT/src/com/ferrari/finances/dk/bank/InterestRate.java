...
/**
 * Information Expert for the variable interest rate of bank loans. This class
 * provides a (Singleton) link to the bank, which can be used to access
 * information about the bank's interest rates.
 * 
 * @see #todaysRate()
 */
public class InterestRate {
	...
	/**
	 * Restricted constructor for Singleton creation. Visibility is relaxed from
	 * private to protected for testing purposes. The constructor should never be
