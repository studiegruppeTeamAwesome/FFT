...
/**
 * Information Expert for credit rating. This class provides a (Singleton) link
 * to RKI, which can be used to access information about individual credit
 * scores.
 * <p/>
 * 
 * For testing purposes, the following invalid (but working) CPR numbers can be
 * used to retrieve a specific credit rating:
 * <p/>
 * 
 * A: 0000000000<br/>
 * B: 0000000001<br/>
...
public class CreditRator {
	...
	/**
	 * Provides a credit rating for specific individual. The assessment may take
	 * several seconds to complete.
	 * 
	 * @param cpr
	 *            of the individual to rate
