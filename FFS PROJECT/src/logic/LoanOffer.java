...
public class LoanOffer {
	...
	/* 
	 * 2 different constructors because we need the autogenerated id from the database
	 * when we have to approve and export it, but when we want to make it in the guy we dont have it yet
	 */
